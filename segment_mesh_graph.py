####################################################################################
## makeVarD.pyで全ての組み合わせで、２点間の距離の標準偏差を求めた。
## これを用いて、メッシュに標準偏差の逆数を重みとして持たせた無向グラフの
## 隣接行列を作成し、グラフスペクトラルクラスタリングによってノードにラベルを与える。
## このラベルをk-means++クラスタリングすることで、セグメンテーションを行う。
####################################################################################
